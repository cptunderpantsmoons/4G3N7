...
Common labels
*/}}
{{- define "4g3n7-agent.labels" -}}
helm.sh/chart: {{ include "4g3n7-agent.chart" . }}
{{ include "4g3n7-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "4g3n7-agent.selectorLabels" -}}
app.kubernetes.io/name: {{ include "4g3n7-agent.name" . }}
...
*/}}
{{- define "4g3n7-agent.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "4g3n7-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "4g3n7-agent.databaseUrl" -}}
