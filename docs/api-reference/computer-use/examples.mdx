...
description: "Code examples for common automation scenarios using the 4G3N7 API"
---
...
await controlComputer("click_mouse", { button: "left" });
    ...
    await controlComputer("type_text", {
      text: "This is an automated test using Node.js and 4G3N7",
      delay: 30
    });
...
# Write a text file
result = write_file("/home/user/hello.txt", "Hello, 4G3N7!")
...
4G3N7 can serve as an alternative to Selenium for web testing:
