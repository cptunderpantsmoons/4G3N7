---
title: 'Task UI'
description: 'Documentation for the 4G3N7 Task UI'
---

## 4G3N7 Task UI

The 4G3N7 Task UI provides a web-based interface for interacting with the 4G3N7 agent system. It combines a action feed with an embedded noVNC viewer, allowing you to watch it perform task on the desktop in real-time.

<img src="/static/chat-ui-overview.png" alt="4G3N7 Task Detail" className="w-full max-w-4xl" />

## Accessing the UI

When running the full 4G3N7 agent system, the Task UI is available at:
...
The task interface displays different types of messages based on 4G3N7's content block structure:
...
The 4G3N7 Task UI is built with:
...
1. Ensure all 4G3N7 services are running
...
1. Ensure the 4G3N7 container is running
