---
title: "Introduction"
description: "Overview of the 4G3N7 REST API"
---

## 4G3N7 REST API

4G3N7's core functionality is exposed through its REST API, which provides endpoints for interacting with the desktop environment. The API allows for programmatic control of mouse movement, keyboard input, and screen capture.
...
The 4G3N7 API does not require authentication by default when accessed locally. For remote access, standard network security practices should be implemented.
