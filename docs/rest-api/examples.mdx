...
description: "Code examples for common automation scenarios using the 4G3N7 REST API"
---

This page provides practical examples of how to use the 4G3N7 REST API in different programming languages and scenarios.
...
async function fillForm() {
  ...
  await controlComputer("type_text", {
    text: "This is an automated message sent using 4G3N7's Computer Use API",
    delay: 30,
  });
...
You can create a reusable automation framework with 4G3N7:
...
class 4G3N7Driver:
    """A Selenium-like driver for 4G3N7"""
