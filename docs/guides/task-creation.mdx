...
# Creating and Managing Tasks in 4G3N7

This guide will walk you through everything you need to know about creating tasks that 4G3N7 can execute effectively, and managing them through their lifecycle.

## Understanding Tasks

A task is any job you want 4G3N7 to complete. Tasks can be:
...
4G3N7 has powerful file handling capabilities that make it perfect for document processing and data analysis tasks.
...
- **Document Processing**: Upload PDFs, spreadsheets, or documents for 4G3N7 to analyze
...
<Note>
  **Game Changer**: 4G3N7 can read entire files, including PDFs, directly into the LLM context. This means it can process large amounts of data quickly and understand complex documents without manual extraction.
</Note>
...
<Steps>
  ...
  <Step title="Start Task">
    Press the arrow button or hit Enter. 4G3N7 will start loading and begin working on your task.
  </Step>
</Steps>
...
(4G3N7 handles all authentication including 2FA automatically via password manager)
```
...
Watch 4G3N7 work through the task detail viewer:

- **Green dot**: Task is actively running
- **Status messages**: Current step being executed
- **Desktop view**: See what 4G3N7 sees in real-time

#### Chat Messages

4G3N7 provides updates like:
```
...
(Note: 4G3N7 handles all authentication including 2FA automatically using the built-in password manager)
...
After each task:
1. Review the approach 4G3N7 took
...
<Note>
  **Pro Tip**: Start with simple tasks to understand 4G3N7's capabilities, then gradually increase complexity as you learn what works best.
</Note>