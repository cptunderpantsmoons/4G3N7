---
title: "Takeover Mode"
description: "Take control of the desktop when you need to guide or assist 4G3N7"
---

# Takeover Mode: Human-AI Collaboration

Takeover mode lets you take control of the desktop to help 4G3N7 when needed. There are two ways to use it:
...
All your actions during takeover (clicks, drags, scrolls, typing, key presses) are automatically logged in the same unified action space that the agent uses. This means 4G3N7 understands and learns from everything you do.
...
<Steps>
  <Step title="Open Task Detail View">
    While 4G3N7 is working on a task, click on the task to open the detail view.
  </Step>
  ...
  <Step title="Guide 4G3N7">
    Perform the necessary actions to get past the obstacle or show the correct path.
  </Step>
  
  <Step title="Release Control">
    Click to release control and let 4G3N7 continue from where you left off.
  </Step>
</Steps>

### Method 2: Automatic When Help Needed

When 4G3N7 sets a task status to "needs help":
- Takeover mode is automatically enabled
- You'll see a notification that 4G3N7 needs assistance
- Take control to help resolve the issue
- 4G3N7 will continue once you release control
...
<Card title="Handling Unexpected Situations" icon="exclamation-triangle">
  **Scenario**: 4G3N7 encounters an error or gets stuck
  
  **Steps**:
  1. Notice 4G3N7 is struggling
  2. Take control to resolve the issue
  3. Guide it past the problem
  4. Explain what went wrong in chat
  5. Return control to let 4G3N7 continue
...
<Card title="Show Don't Tell" icon="graduation-cap">
  ...
  **Steps**:
  ...
  4. Return control
  5. Ask 4G3N7 to repeat the process
...
- **Test Understanding**: Ask 4G3N7 to summarize what it learned

### Don'ts ❌

- **Enter Data You Don't Want Captured**: Screenshots are taken of all actions
- **Skip Chat Explanations**: Context helps 4G3N7 learn patterns
...
<Note>
  **No Need to Move Slowly**: 4G3N7 captures the state before and after each action, so you can work at normal speed.
</Note>


## Summary

Takeover mode provides flexibility when you need to guide 4G3N7 or handle situations it can't manage alone. Whether you're navigating complex interfaces, recovering from errors, or teaching new workflows, takeover mode ensures you're always in control when needed.