...
description: "The virtual Linux desktop where 4G3N7 performs tasks"
---

## Overview

The 4G3N7 Desktop Environment (also called 4G3N7 Core) is a complete Linux desktop that runs in a Docker container. This is where 4G3N7 does its work - clicking buttons, typing text, browsing websites, and using applications just like you would.

<img
  src="/images/core-container.png"
  alt="4G3N7 Desktop Environment"
...
```dockerfile
FROM ghcr.io/4g3n7-ai/4g3n7-desktop:edge
